...
from app_setor.serializers import SetorSerializer
from app_grupo.serializers import GrupoSerializer
...
class UsuarioSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Usuario
        fields = [
            'id', 'nome_usuario', 'email', 'password',
            'ativo', 'is_staff', 'is_superuser',
            'empresa', 'setor', 'grupos',
        ]
...
class UsuarioLoginSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Usuario
        fields = [
            'id', 'nome_usuario', 'email', 'ativo',
            'is_staff', 'is_superuser', 'empresa', 'setor', 'grupos',
        ]
