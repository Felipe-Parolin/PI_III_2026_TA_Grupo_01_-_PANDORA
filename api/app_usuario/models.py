...
class Usuario(AbstractBaseUser, PermissionsMixin):
    ...
    empresa = models.ForeignKey(Empresa, on_delete=models.RESTRICT, related_name='usuarios', null=True, blank=True)
    setor = models.ForeignKey(Setor, on_delete=models.RESTRICT, related_name='usuarios', null=True, blank=True)
